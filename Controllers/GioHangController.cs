...
namespace DoAn_ShopOnline.Controllers
{
    ...
    public class GioHangController : Controller
    {
        ...
        //mỗi cái forecsh sẽ là 1 cái form chứa iduser , masp , so luong , sau do cap nhat lai so luong


        // xóa sản phảm đó dựa vào mã sản phảm được chọn xóa , id đang thực hiện xóa
